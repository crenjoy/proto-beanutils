 ...
 * <b>java.util.Calendar</b> objects.
 * <p>
 * This implementation can be configured to handle conversion either by using a
 * Locale's default format or by specifying a set of format patterns (note,
 * there is no default String conversion for Calendar). See the
...
public final class CalendarConverter extends DateTimeConverter<Calendar> {
  ...
  /**
   * Constructs a <b>java.util.Calendar</b> <i>Converter</i> that throws a
  ...
  /**
   * Constructs a <b>java.util.Calendar</b> <i>Converter</i> that returns a
