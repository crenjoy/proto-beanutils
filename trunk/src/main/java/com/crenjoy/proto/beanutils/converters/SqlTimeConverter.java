 ...
 * <b>java.sql.Time</b> objects.
 * <p>
 * This implementation can be configured to handle conversion either by using
 * java.sql.Time's default String conversion, or by using a Locale's default
...
public final class SqlTimeConverter extends DateTimeConverter<Time> {
  ...
  /**
   * Constructs a <b>java.sql.Time</b> <i>Converter</i> that throws a
  ...
  /**
   * Constructs a <b>java.sql.Time</b> <i>Converter</i> that returns a default
