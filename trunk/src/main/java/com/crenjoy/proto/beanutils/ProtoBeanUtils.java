 ...
 *
 * <p>
 * The implementations are provided by {@link BeanUtilsBean}. These static
 * utility methods use the default instance. More sophisticated behavior can be
 * provided by using a {@code BeanUtilsBean} instance.
 * </p>
 *
 * @see BeanUtilsBean
 */
...
public class ProtoBeanUtils {
   ...
   */
  public static Object cloneBean(final Object bean) throws IllegalAccessException,
      InstantiationException, InvocationTargetException, NoSuchMethodException {
    return ProtoBeanUtilsBean.getInstance().cloneBean(bean);
  }
   ...
   *                                   property type is different from the source
   *                                   type and the relevant converter has not
   *                                   been registered.
   * @throws InvocationTargetException if the property accessor method throws an
   *                                   exception
  ...
  public static void copyProperties(final Object dest, final Object orig)
    ...
    ProtoBeanUtilsBean.getInstance().copyProperties(dest, orig);
  }
  ...
  public static void copyProperty(final Object bean, final String name, final Object value)
      throws IllegalAccessException, InvocationTargetException {
    ProtoBeanUtilsBean.getInstance().copyProperty(bean, name, value);
  }
  ...
  public static Map<String, String> describe(final Object bean)
    ...
    return ProtoBeanUtilsBean.getInstance().describe(bean);
  }
  ...
  public static String[] getArrayProperty(final Object bean, final String name)
      throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
    return ProtoBeanUtilsBean.getInstance().getArrayProperty(bean, name);
  }
  ...
  public static String getIndexedProperty(final Object bean, final String name)
      throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
    return ProtoBeanUtilsBean.getInstance().getIndexedProperty(bean, name);

  }

  /**
   * Gets the value of the specified indexed property of the specified bean, as a
   * String. The index is specified as a method parameter and must *not* be
  ...
  public static String getIndexedProperty(final Object bean, final String name, final int index)
      throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
    return ProtoBeanUtilsBean.getInstance().getIndexedProperty(bean, name, index);
  }
  ...
  public static String getMappedProperty(final Object bean, final String name)
    ...
    return ProtoBeanUtilsBean.getInstance().getMappedProperty(bean, name);
  ...
  public static String getMappedProperty(final Object bean, final String name, final String key)
      throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
    return ProtoBeanUtilsBean.getInstance().getMappedProperty(bean, name, key);
  }
  ...
  public static String getNestedProperty(final Object bean, final String name)
      throws IllegalAccessException, InvocationTargetException, NoSuchMethodException {
    return ProtoBeanUtilsBean.getInstance().getNestedProperty(bean, name);
  }
  ...
  public static String getProperty(final Object bean, final String name)
    ...
    return ProtoBeanUtilsBean.getInstance().getProperty(bean, name);
  ...
  public static String getSimpleProperty(final Object bean, final String name)
    ...
    return ProtoBeanUtilsBean.getInstance().getSimpleProperty(bean, name);
  ...
  public static void populate(final Object bean, final Map<String, ? extends Object> properties)
    ...
    ProtoBeanUtilsBean.getInstance().populate(bean, properties);
  }
  ...
  public static void setProperty(final Object bean, final String name, final Object value)
    ...
    ProtoBeanUtilsBean.getInstance().setProperty(bean, name, value);
  }
