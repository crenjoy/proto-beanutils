 ...
 * there is no default String conversion for Date). See the
...
public final class DateConverter extends DateTimeConverter<Date> {
  ...
  /**
   * Constructs a <b>java.util.Date</b> <i>Converter</i> that throws a
  ...
  /**
   * Constructs a <b>java.util.Date</b> <i>Converter</i> that returns a default
