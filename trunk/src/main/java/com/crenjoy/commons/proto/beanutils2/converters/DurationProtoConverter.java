...
public final class DurationProtoConverter extends AbstractConverter<Duration> {
   ...
   *                     value.
   */
  public DurationProtoConverter(final Duration defaultValue) {
    super(defaultValue);
  }
  ...
  protected String convertToString(final Object value) {
    if (value instanceof com.google.protobuf.Duration) {
      com.google.protobuf.Duration d = (com.google.protobuf.Duration) value;
      return DurationUtils.toTime(d).toString();
    }
